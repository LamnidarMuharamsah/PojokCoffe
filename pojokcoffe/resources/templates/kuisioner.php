...
$(document).on('click','.update',function(){
    ...
    // var json = $.parseJSON(data1.detail);
        ...
        for (var i = 0; i < json.length; i++) {
             $('#tableBahan').append(
            '<tr class="transaksi-row"><td><input type="text" class="form-control" name="pertanyaan[]" value="'+json[i].pertanyaan+'" required><input type="hidden" class="form-control" value="'+json[i].id_pertanyaan+'" name="id_pertanyaan[]"></td>'+
            '<td>'+
...
$(document).on('click','.view',function(){
    ...
    $.post("kuisioner.php?a=edit", {idx: idx}).done(function( data1 ) {
      ...
      $('[name="tgl_selesai"]').val(json.tgl_selesai);
      $('[name="id_pegawai"]').val(json.id_pegawai);
      $.post("kuisioner.php?a=edit_detail_jawaban", {idx: json.id_kuisioner}).done(function( data ) {
    // var json = $.parseJSON(data1.detail);
        var json = $.parseJSON(data);
        for (var i = 0; i < json.length; i++) {
             $('#tableView').append(
            ...
            '<td>'+json[i].sangat_baik+'</td><td>'+json[i].baik+'</td><td>'+json[i].cukup_baik+'</td><td>'+json[i].buruk+'</td><td>'+json[i].sangat_buruk+'</td></tr>'
          );
        }
      });
        // $('[name="requester_institution"]').val(json.requester_institution);
...
<h2><?=$pageTitle?></h2>
                    ...
                    <div class="col-lg-12">
                        ...
                        <?php
                          if($_SESSION['jabatan']!=3){
                            ?>
                         <a data-target="#modal-admin" data-backdrop="static" data-toggle="modal" style="padding: 4px" class="btn btn-sm btn-primary text-black add">Tambah Kuisioner</a>
                         <?php } ?>
                         <br><br>
                            ...
                            <table name="asd" class='table table-bordered table-hover table-striped' width="100%" id="dataTables-export">
                                ...
                                ?>
                                    ...
                                    <?php
                                      ...
                                      <?php } ?>
                                        <a data-target="#modal-view" data-backdrop="static" data-toggle="modal" class="view btn btn-sm btn-white text-black"><i class="fa fa-search fa-lg"></i></a>  
      ...
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form name="form-<?php echo $title; ?>" id="myForm" method="POST" action="../public_html/kuisioner.php?a=save_data" class=" form-horizontal">
            <div class="row">
                <div class="form-group required" style="margin-bottom: 20px">
                 ...
                 <div class="form-group required">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" maxlength="50" required name="judul_kuisioner" placeholder="Judul">
                  </div>
                </div>
                <div class="form-group required">
                  <label class="col-sm-3 control-label">Tanggal Selesai</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control datepicker" maxlength="50" required name="tgl_selesai" placeholder="Tanggal Selesai">
                  </div>
                </div>
                
                <div class="col-lg-12">
                  <table class="table table-striped table-bordered" id="tableBahan" width="100%">
                    <tr><td width="80%">Pertanyaan</td><td></td></tr>
          ...
          <div class="modal-footer">
            ...
            <input type="submit" class="save btn btn-primary" value="Save"></button>
          </div>
          </form>
        </div>
     ...
     <div id="modal-view" class="modal fade" role="dialog" style="display:none">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                  <table class="table table-striped table-bordered" id="tableView" width="100%">
