...
<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">Pembayaran</a></li>
  <li><a data-toggle="tab" href="#menu1">Riwayat Pembayaran</a></li>
</ul>
                            ...
                            <table name="asd" class='table table-bordered table-hover table-striped' width="100%" id="dataTables-export">
                                ...
                                ?>
                                    <tr idx='<?=$a['id_pemesanan']?>'><td><?=$i?></td><td><?=$a['id_pemesanan']?><td><?=$a['tgl_pesan']?></td><td><?=$a['no_meja']?></td><td>
                                        <a data-target="#modal-admin" data-backdrop="static" data-toggle="modal" class="update btn btn-sm btn-white text-black"><i class="fa fa-money fa-lg"></i></a>  
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive">
                            <table name="asd" class='table table-bordered table-hover table-striped' width="100%" id="dataTables-export2">
                                ...
                                ?>
                                    <tr id='<?=$a['id_pembayaran']?>' idx='<?=$a['id_pemesanan']?>'><td><?=$i?></td><td><?=$a['id_pemesanan']?><td><?=$a['diskon']?></td><td><?=$a['total_bayar']?></td><td><?=$a['bayar']?></td><td><?=$a['kembalian']?></td><td>
